package com.example.peacebridgesinstagram
...
/**
 * Let user create post by taking a photo
 */
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //2. A button to launch the camera tot ake a picture
        //3. An imageview to show the picture the user has taken
        //4. A button to save and send the ppost to our Parse server

        findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            //send post to server without an image
            //grab the description they have inpiuted
    ...
    fun submitPost (description: String, user:  ParseUser, file: File) {
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                Log.i(TAG, "Error while saving ppost")
